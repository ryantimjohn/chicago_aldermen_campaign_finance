...
function loadMap(ward, request) {
  ...
  for (var line in obj) {
    ...
    var content = '<div id="content">' +
      '<div id="siteNotice">' +
      '</div>' +
      '<h3 id="firstHeading" class="firstHeading" style="color:#c60000"> <a href="https://www.google.com/search?q=' + obj[line]["first_name"] + " " + obj[line]["last_name"] + '" target="_blank">' + obj[line]["first_name"] + " " + obj[line]["last_name"] + '</a></h3>' +
